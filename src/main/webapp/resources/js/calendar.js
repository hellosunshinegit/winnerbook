...
// $Id: calendar.js,v 1.1 2013/03/27 12:40:08 gehong Exp $
...
// IsValidDate,the format is yyyy-mm-dd,yyyy-m-dd,yyyy-mm-d or yyyy-m-d
function IsValidDate(inputTxt){
		var dateString = inputTxt.value;
        ...
        if(dateArr[0].length==4){
            ...
            if(date.getFullYear()==dateArr[0]&&date.getMonth()==dateArr[1]-1&&date.getDate()==dateArr[2]){
                return true;
            }
        }
        ...
        if(dateArr[2].length==4){
            ...
            if(date.getFullYear()==dateArr[2]&&date.getMonth()==date[0]-1&&date.getDate()==dateArr[1]){
                return true;
            }
        }
        ...
        if(dateArr[2].length==4){
            ...
            if(date.getFullYear()==dateArr[2]&&date.getMonth()==dateArr[1]-1&&date.getDate()==dateArr[0]){
                return true;
            }
        }
        alert("日期格式错误！");
